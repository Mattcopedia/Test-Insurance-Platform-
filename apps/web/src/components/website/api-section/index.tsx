  ...
  return (
    <section className="relative py-14 lg:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1800px] px-6 lg:px-16 space-y-8 lg:space-y-10">
        {/* Main API Card */}
        <div className="bg-white rounded-[20px] shadow-[0px_4px_160px_0px_rgba(0,0,0,0.25)] overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
          {/* UX Card */}
          <div className="bg-white rounded-[20px] shadow-[0px_4px_160px_0px_rgba(0,0,0,0.25)] p-8 lg:p-12 flex flex-col items-center text-center gap-6">
